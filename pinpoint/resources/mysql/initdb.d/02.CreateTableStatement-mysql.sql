...
ALTER TABLE user_group_member
    ADD UNIQUE KEY user_group_id_member_id_idx (`user_group_id`, `member_id`);
...
ALTER TABLE alarm_rule
    ADD INDEX application_id_checker_name_user_group_id_idx (application_id, user_group_id, checker_name);
...
ALTER TABLE alarm_history
    ADD INDEX application_id_checker_name_idx (application_id, checker_name);
